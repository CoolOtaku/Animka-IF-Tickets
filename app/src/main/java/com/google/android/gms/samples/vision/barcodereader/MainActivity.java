    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.bVerify:
                ...
                toast.showToas(getApplicationContext(),true);
                break;
        }
    }
